...
public class KnightUpgrade1 : Upgradeable
{
    ...
    public override void Upgrade()
    {
        if (gameState.currentPlayer != "black")
        {
                ...
                {
                    if (gameState.playerBlack[k] != null && gameState.playerBlack[k].GetComponent<ChessPiece>().name == "knight")
                    {
        ...
        else if (gameState.currentPlayer != "white")
        {
                ...
                {
                    if (gameState.playerWhite[k] != null && gameState.playerWhite[k].GetComponent<ChessPiece>().name == "knight")
                    {
